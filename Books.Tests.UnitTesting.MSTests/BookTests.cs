...
namespace Books.Tests.UnitTesting.MSTests
{
    ...
    public class BookTests
    {
        ...
        public void Test_Constructor_WhenInputIsSevenParameters_ReturnsAuthorObject()
        {
            ...
            Book book = new Book(expectedIds, expectedTitle, expectedPages, expectedIds, expectedIds, expectedIds, expectedReleasedDate);
        ...
        public void Test_SetId_SetValueToId()
        {
            ...
            Book book = new Book(startId, expectedTitle, expectedPages, expectedIds, expectedIds, expectedIds, expectedReleasedDate);
        ...
        public void Test_SetTitle_SetValueToTitle()
        {
            ...
            Book book = new Book(expectedIds, startTitle, expectedPages, expectedIds, expectedIds, expectedIds, expectedReleasedDate);
        ...
        public void Test_SetPages_SetValueToPages()
        {
            ...
            Book book = new Book(expectedIds, expectedTitle, startPages, expectedIds, expectedIds, expectedIds, expectedReleasedDate);
        ...
        public void Test_SetGenreId_SetValueToGenreId()
        {
            ...
            Book book = new Book(expectedIds, expectedTitle, expectedPages, startId, expectedIds, expectedIds, expectedReleasedDate);
        ...
        public void Test_SetAuthorId_SetValueToAuthorId()
        {
            ...
            Book book = new Book(expectedIds, expectedTitle, expectedPages, expectedIds, startId, expectedIds, expectedReleasedDate);
        ...
        public void Test_SetPublisherId_SetValueToPublisherId()
        {
            ...
            Book book = new Book(expectedIds, expectedTitle, expectedPages, expectedIds, expectedIds, startId, expectedReleasedDate);
        ...
        public void Test_SetReleaseDate_SetValueToReleaseDate()
        {
            ...
            Book book = new Book(expectedIds, expectedTitle, expectedPages, expectedIds, expectedIds, expectedIds, startReleaseDate);
